                ...
                <div className="space-y-2 text-sm">
                  {revealedData.email && (
                    <div className="flex items-center gap-2">
                      ...
                      <a href={`mailto:${revealedData.email}`} className="text-blue-600 hover:underline">{revealedData.email}</a>
                    </div>
                  )}
                  {revealedData.phone && (
                    <div className="flex items-center gap-2">
                      ...
                      <a href={`tel:${revealedData.phone}`} className="text-blue-600 hover:underline">{revealedData.phone}</a>
                    </div>
                  )}
                  {revealedData.cv_url && (
                    <div className="flex items-center gap-2">
                      ...
                      <a href={`${API_BASE}${revealedData.cv_url}`} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Download CV</a>
                    </div>
                  )}
                </div>
              </div>
